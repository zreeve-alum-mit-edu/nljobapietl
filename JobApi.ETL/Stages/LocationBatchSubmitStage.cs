...
public class LocationBatchSubmitStage
{
    private readonly HttpClient _httpClient;
    private readonly string _apiKey;
    private const int MaxBatchesInFlight = 2;

    public LocationBatchSubmitStage()
    {
    ...
    {
        Console.WriteLine("=== LOCATION BATCH SUBMIT STAGE ===");

        using var db = JobContext.Create();

        // Check how many batches are currently in flight
        var inFlightCount = await db.LocationBatches
        ...
        var pendingBatches = await db.LocationBatches
        ...
        Console.WriteLine("\n=== Location Batch Submit Complete ===");
        return true;
    }
