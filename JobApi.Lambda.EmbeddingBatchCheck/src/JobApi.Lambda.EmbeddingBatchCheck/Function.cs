...
namespace JobApi.Lambda.EmbeddingBatchCheck;
...
public class Function
{
    ...
    /// <summary>
    /// Lambda handler for checking Embedding batch status
    /// Triggered hourly by EventBridge
    /// </summary>
    public async Task FunctionHandler(ILambdaContext context)
    {
        context.Logger.LogInformation("=== Embedding Batch Check Started ===");
        ...
        context.Logger.LogInformation("=== Embedding Batch Check Complete ===");
    }
    ...
    private async Task DownloadAndUploadResults(EmbeddingBatch batch, string outputFileId, ILambdaContext context)
    {
